...
define('QTYPE_DDIMAGEORTEXT_BGIMAGE_MAXWIDTH', 720);
define('QTYPE_DDIMAGEORTEXT_BGIMAGE_MAXHEIGHT', 480);
define('QTYPE_DDIMAGEORTEXT_DRAGIMAGE_MAXWIDTH', 120);
define('QTYPE_DDIMAGEORTEXT_DRAGIMAGE_MAXHEIGHT', 80);
