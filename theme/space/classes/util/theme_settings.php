...
class theme_settings {
  ...
  public function team() {
      ...
      $templatecontext = [];
      $teamitems = [
        'FPTeam', 'FPTeamIntroProperties', 'FPTeamFooterContent', 'teammemberno'
      ];
      ...
      for ($i = 1, $j = 0; $i <= $teamcount; $i++, $j++) {
          ...
          if (!empty($theme->settings->$teamurl)) {
            $templatecontext['team'][$j]['teamurl'] = format_text(($theme->settings->$teamurl),FORMAT_HTML, array('noclean' => true));
          }
  ...
  public function logos() {
    ...
    $templatecontext = [];
    $logositems = [
      'FPLogos', 'FPLogosFooterContent', 'FPLogosProperties', 'ShowFPLogosIntro'
    ];
  ...
  public function hero() {
    ...
    $templatecontext = [];
    $hero = [
      'herofwenabled', 'heroshadow', 'heroboxshadow', 'herovideoenabled', 'showherologo'
    ];
  ...
  public function block3() {
    ...
    $block3html = [
      'FPHTMLBlock3Heading', 'FPHTMLBlock3Text', 'FPHTMLBlock3Label', 'FPHTMLBlock3URL'
    ];
  ...
  public function block11() {
    ...
    for ($i = 1, $j = 0; $i <= $fpblock11count; $i++, $j++) {
      ...
      if (!empty($theme->settings->$fpblock11url)) {
        $templatecontext['block11'][$j]['fpblock11url'] = format_text(($theme->settings->$fpblock11url),FORMAT_HTML, array('noclean' => true));
      }
...
public function block12() {
      ...
      $templatecontext = [];
      $block12 = [
        'fpblock12', 'showfpblock12intro', 'fpblock12introclass'
      ];
