...
defined('MOODLE_INTERNAL') || die();
    ...
    $string['HR_desc'] = 'Categories Block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block-cat.png" class="img-fluid rounded mt-3" />';

    $string['HR1'] = '<div class="d-block text-center"><br /><br />Block #1</div>';
    $string['HR1_desc'] = '3-Column HTML Block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block1.png" class="img-fluid rounded mt-3" />';

    $string['HR2'] = '<div class="d-block text-center"><br /><br />Block #2</div>';
    $string['HR2_desc'] = '2-column HTML Block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block2.png" class="img-fluid rounded mt-3" />';

    $string['HR3'] = '<div class="d-block text-center"><br /><br />Block #3</div>';
    $string['HR3_desc'] = 'Call to action block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block6.jpg" class="img-fluid rounded mt-3" />';

    $string['HR4'] = '<div class="d-block text-center"><br /><br />Block #4</div>';
    $string['HR4_desc'] = 'Single Column HTML Block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block4.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR12_desc'] = 'Custom Navigation Block on the Sidebar. Custom Text Block on the Sidebar.<br /><img src="https://assets.rosea.io/space/docs/sidebar-customnav.png" class="img-fluid rounded mt-3" /><br /><br /><hr /><div class="small">You can also add additional navigation using in-build moodle field. <br /><strong><Go to:</strong> Dashboard → Site administration → Appearance → Themes → Theme settings → <strong>Scroll to:</strong> Custom menu items</div><br /><img src="https://assets.rosea.io/space/docs/sidebar-customnav-2.png" class="img-fluid rounded" />';

    $string['HR13'] = '<div class="d-block text-center"><br /><hr/><br />Custom Text</div>';
    $string['HR13_desc'] = 'Custom Text Block on the Sidebar.<br /><img src="https://assets.rosea.io/space/docs/sidebar-custom-html.png" class="img-fluid rounded mt-3" />';

    $string['HR14'] = '<div class="d-block text-center"><br /><br />Categories</div>';
    $string['HR14_desc'] = 'Single Column HTML Block on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block6.png" class="img-fluid rounded mt-3" />';

    $string['HR15'] = '<div class="d-block text-center"><br /><br />Sidebar</div>';
    $string['HR15_desc'] = '<div class="small">You can add custom logo below or go to: Dashboard → Site administration → Appearance → Logos.</div><br /><img src="https://assets.rosea.io/space/docs/fp-block6.png" class="img-fluid rounded mt-3" />';

    $string['HRLogo'] = '<div class="d-block text-center"><br /><br />Logotypes</div>';
    $string['HRLogo_desc'] = 'You can add up to 30 logotypes on the front page.<br /><img src="https://assets.rosea.io/space/docs/fp-block-logos.png" class="img-fluid rounded mt-3" />';

    $string['HRTeam'] = '<div class="d-block text-center"><br /><br />Team</div>';
    $string['HRTeam_desc'] = 'You can add up to 60 team members on the front page. <br /><img src="https://assets.rosea.io/space/docs/fp-block-team.jpg" class="img-fluid rounded mt-3" />';

    $string['HRTopBar'] = '<div class="d-block text-center"><hr /><br />Top Bar Text</div>';
    $string['HRTopBar_desc'] = 'Custom text on the top bar.<br /><img src="https://assets.rosea.io/space/docs/topbar-info.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR16_desc'] = '<div class="small mb-0"><h5>Language menu:</h5><ul class="list-unstyled"><li>Go to: Dashboard → Site administration → Language → Language settings</li><li>Check: Display language menu</li><li>Save</li></ul></div><img src="https://assets.rosea.io/space/docs/topbar-lang.png" class="img-fluid rounded mt-3" /><br /><br /><div class="small mb-0"><h5>Search box:</h5><ul class="list-unstyled"><li>Go to: Dashboard → Site administration → Advanced features</li><li>Check Enable global search</li> <li>Save</li></ul></div><img src="https://assets.rosea.io/space/docs/topbar-search.png" class="img-fluid rounded mt-3" />';
    ...
    $string['HR23_desc'] = 'You can change position of each blocks on the front page.<br /><img src="https://assets.rosea.io/space/docs/simple-front-page-builder.png" class="img-fluid rounded mt-4" />';

    $string['HR24'] = '<div class="d-block text-center"><br /><br />Top Bar Styles</div>';
    $string['HR24_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/topbar-styles.png" class="img-fluid rounded mt-3" />';

    $string['HR25'] = '<div class="d-block text-center"><hr /><br />Sidebar Colors</div>';
    $string['HR25_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/sidebar-colors.png" class="img-fluid rounded mt-3" />';

    $string['HR26'] = '<div class="d-block text-center"><hr /><br />Theme Colors</div>';
    $string['HR26_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-blue-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR27'] = '<div class="d-block text-center"><hr /><br />Yellow - Default Palette</div>';
    $string['HR27_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-yellow-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR28'] = '<div class="d-block text-center"><hr /><br />Green - Default Palette</div>';
    $string['HR28_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-green-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR29'] = '<div class="d-block text-center"><hr /><br />Purple - Default Palette</div>';
    $string['HR29_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-purple-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR30'] = '<div class="d-block text-center"><hr /><br />Red - Default Palette</div>';
    $string['HR30_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-red-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR31'] = '<div class="d-block text-center"><hr /><br />Gray - Default Palette</div>';
    $string['HR31_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-gray-palette.png" class="img-fluid rounded mt-3" />';

    $string['HR32'] = '<div class="d-block text-center"><div class="d-block text-center"><br />Button Primary</div>';
    $string['HR32_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-btn-primary.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-primary">Button Primary</div>';
    
    $string['HR33'] = '<div class="d-block text-center"><hr /><br />Button Secondary</div>';
    $string['HR33_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-btn-secondary.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-secondary">Button Secondary</div>';

    $string['HR34'] = '<div class="d-block text-center"><hr /><br />Button Reset</div>';
    $string['HR34_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-btn-reset.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-reset">Button Reset</div>';

    $string['HR35'] = '<div class="d-block text-center"><hr /><br />Button Special</div>';
    $string['HR35_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-btn-special.png" class="img-fluid rounded mt-3" /><br /><br /><small class="mr-2">Your button style (preview):</small> <div class="btn btn-special">Button Special</div>';

    $string['HR36'] = '<div class="d-block text-center"><hr /><br />Card</div>';
    $string['HR36_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-card.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR38_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-footer.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR47_desc'] = '<br /><img src="https://assets.rosea.io/space/docs/colors-dropdown.png" class="img-fluid rounded mt-3" /><br /><br />';
    ...
    $string['HR50'] = '<div class="d-block text-center"><hr /><br />Custom Modal</div><br /><img src="https://assets.rosea.io/space/docs/custommodal.png" class="img-fluid rounded mt-3" alt="Custom Modal"/>';
    $string['HR50_desc'] = '<br />';
    ...
    ***/
    ...
    $string['loginbg_desc'] = 'Recommended size: 1920x1080px.<br /><div class="badge badge-success"><strong>Remember</strong> to check the fied: <strong>"Show Background Image"</strong>.</div>';
    ...
    ***/
    ...
    $string['teamtext_desc'] = 'Description to team member';
    ...
    $string['teamname_desc'] = 'Team member name';
...
&lt;/div&gt;</pre><br /><hr class="hr-bold" />';
    ...
    $string['showherologo_desc'] = '<strong>Go to</strong> Dashboard → Site administration → Appearance → Logos. <br />Recommendation: Logo height: 120px';

    $string['heroslidershadow'] = 'Show Shadow Behind Slider';
    $string['heroslidershadow_desc'] = '';
    ...
    ***/
    ...
    $string['SidebarCustomBox'] = '✓ Turn on Sidebar Custom Box';
    ...
    $string['SidebarCustomNav'] = '✓ Turn on Sidebar Custom Navigation';
...
&lt;/ul&gt;</code></pre>';
    ...
    *
    ***/
    $string['frontpagesettings'] = 'Hero Image - General';
    ...
    ***/
    ...
    $string['herovideoenabled_desc'] = '<div class="badge badge-info"><strong>Important</strong> You have to add: <strong>mp4, ogv, webm</strong> and <strong>hero image</strong> which will be a placeholder.</div>';
    ...
    $string['HeroHeading_desc'] = '';

    $string['HeroText'] = '<small>Hero</small><br />Description';
    $string['HeroText_desc'] = '';

    $string['HeroText2'] = '<small>Hero</small><br />Additional Heading';
    $string['HeroText2_desc'] = '';

    $string['HeroLabel'] = '<small>Hero</small><br />Button #1 Label';
    $string['HeroLabel_desc'] = 'Main Button Label on the Hero image';

    $string['HeroURL'] = '<small>Hero</small><br />Button #1 URL';
    $string['HeroURL_desc'] = 'Hero Button URL on the Hero image';

    $string['HeroLabel2'] = '<small>Hero</small><br />Button #2 Label';
    $string['HeroLabel2_desc'] = 'Secondary Button Label on the Hero image';

    $string['HeroURL2'] = '<small>Hero</small><br />Button #2 URL';
    $string['HeroURL2_desc'] = 'Secondary Button URL on the Hero image';
    ...
    *
    ***/
    $string['FPHTMLCustomCategoryBlock'] = '✓ Custom Categories Block';
    $string['FPHTMLCustomCategoryBlock_desc'] = 'Turn on Custom Categories Block';
    ...
    $string['FPHTMLCustomCategoryBlockHTML1_desc'] = '<strong>First switch to HTML view.</strong><img src="https://moodle-themes.rosea.io/alpha/theme-assets/htmlview.png" class="img-fluid mt-2 mb-4" ><br />
 ...
 &lt;/ul&gt;</code></pre>';
    ...
    $string['FPHTMLCustomCategoryBlockHTML2_desc'] = '<strong>First switch to HTML view.</strong><img src="https://moodle-themes.rosea.io/alpha/theme-assets/htmlview.png" class="img-fluid mt-2 mb-4" ><br />
    <br><strong>Code snippet: </strong> <pre><code>&lt;ul class=&quot;c-courses-list&quot;&gt;
          &lt;li&gt;&lt;a href=&quot;course/view.php?id=9&quot;&gt;Celebrating Cultures&lt;/a&gt;&lt;/li&gt;
          &lt;li&gt;&lt;a href=&quot;course/view.php?id=8&quot;&gt;Introduction to Open Education&lt;/a&gt;&lt;br&gt;&lt;span class=&quot;small&quot;&gt;&lt;i class=&quot;far fa-calendar-alt&quot;&gt;&lt;/i&gt; January - June  &lt;i class=&quot;m-l-1 fas fa-graduation-cap&quot;&gt;&lt;/i&gt; Teacher: Adam Smith&lt;/span&gt;&lt;/li&gt;
          &lt;li&gt;&lt;a href=&quot;course/view.php?id=7&quot;&gt;Digital Literacy&lt;/a&gt;&lt;/li&gt;
 ...
 &lt;/ul&gt;</code></pre>';
    ...
    ***/
    ...
    $string['FPHTMLBlock1_desc'] = 'Select to turn on HTML Block #1 on the front page';
    ...
    ***/
    ...
    $string['FPHTMLBlock2_desc'] = 'Select to turn on HTML Block #2 on the front page';
    ...
    ***/
    ...
    $string['FPHTMLBlock3'] = '✓ Block #3';
    $string['FPHTMLBlock3_desc'] = 'Select to turn on HTML Block #3 on the front page.<br />If you want to add some custom CSS just override this class <strong>.s-special-box-bg-dark</strong>';
    ...
    ***/
    ...
    $string['FPHTMLBlock4'] = '✓ Block #4';
    $string['FPHTMLBlock4_desc'] = 'Select to turn on HTML Block #4 on the front page.';
...
&#x3C;/div&#x3E;</code></pre>
  <hr class="hr-bold" />';
    ...
    ***/
    ...
    $string['ShowCustomNav_desc'] = 'Select to trun on custom navigation on the top bar.<br /><img src="https://assets.rosea.io/space/docs/topbar-custom-nav.png" class="img-fluid rounded mt-3" />';
...
&lt;/ul&gt;</code></pre><br>More icons you can find here: <a href="https://fontawesome.com/icons">FontAwesome</a>';
    ...
    ***/
    ...
    $string['FPLogos'] = '✓ Logotypes';
    $string['FPLogos_desc'] = 'Turn on Logotypes Block';
...
&#x3C;/div&#x3E;</code></pre>';
    ...
    $string['showsociallist_desc'] = 'Check this field to show up social icons list.<br /><img src="https://assets.rosea.io/space/docs/footer-social.png" class="img-fluid rounded mt-3" />';
    ...
    $string['CustomFooterText_desc'] = 'You can add custom footer content with html tags.<br /><img src="https://assets.rosea.io/space/docs/footer-text.png" class="img-fluid rounded mt-3" />';
...
&#x3C;/li&#x3E;</code></pre>';
    ...
    $string['CustomAlert_desc'] = 'Turn on custom alert. Show up once per session. You can use it as cookie alert. <br /><img src="https://assets.rosea.io/space/docs/customalert.png" class="img-fluid rounded mt-3" alt="Custom Alert" />';
    ...
    $string['slotblock9'] = 'Hero Image/Slider';
    ...
    ***/
    ...
    $string['hfpblock10_desc'] = '<strong>FAQ block</strong>. You can add up to 60 questions and answers.<br /><br /><img src="https://assets.rosea.io/space/docs/space-settings-block10.png" class="img-fluid rounded mt-4" />';

    $string['fpblock10'] = '✓ Turn on';
    $string['fpblock10_desc'] = 'Check to turn on FAQ.';
    ...
    ***/
    ...
    $string['fpblock11_desc'] = 'Turn on Custom Courses List Block';
...
&#x3C;/div&#x3E;</code></pre>
    ...
    ***/
    ...
    $string['hfpblock12_desc'] = '<strong>Testimonials</strong>. Testimonials on the front page. Up to 60.<br /><img src="https://assets.rosea.io/space/docs/space-settings-block12.png" class="img-fluid rounded mt-4" />';
